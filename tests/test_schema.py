...
def test_schema__get_components(drf_request):
...
def test_schema__get_responses(drf_request):
    view = ExampleView()
    view.request = drf_request
    view.request.method = "POST"
    view.format_kwarg = None
...
def test_schema__get_components__from_schema(drf_request):
...
def test_schema__get_components__list(drf_request):
    class CustomSerializer(Serializer):
        """This is the description"""
...
def test_schema__get_components__union(drf_request):
    class CustomSerializer(Serializer):
        """This is the description"""
...
def test_schema__get_responses__from_schema(drf_request):
    class CustomSerializer(Serializer):
        """This is the description"""
...
def test_schema__get_responses__none(drf_request):
    class CustomView(ExampleView):
        """Custom View"""
...
def test_schema__get_responses__union(drf_request):
    class CustomSerializer(Serializer):
        """This is the description"""
...
def test_schema__get_responses__list(drf_request):
    class CustomSerializer(Serializer):
        """This is the description"""
...
def test_schema__get_responses__mock_serializer(drf_request):
    class CustomSerializer(Serializer):
        """This is the description"""
...
def test_schema__get_responses__add_204_if_output_is_list(drf_request):
    class CustomSerializer(Serializer):
        """This is the description"""
...
def test_schema__get_responses__204_if_output_is_emptyserializer(drf_request):
...
def test_schema__get_operation(drf_request):
    class CustomSerializer(Serializer):
        """This is the description"""
...
def test_schema__get_parameters__query(drf_request):
...
def test_schema__get_parameters__query__not_defined(drf_request):
    class CustomView(BasePipelineView):
        """Custom View"""
...
def test_schema__get_parameters__query__default_for_get(drf_request):
    class CustomView(BasePipelineView):
        """Custom View"""
...
def test_schema__get_parameters__query__partial(drf_request):
    class CustomView(BasePipelineView):
        """Custom View"""
...
def test_schema__get__parameters__query__list(drf_request):
...
def test_schema__get_parameters__header(drf_request):
    class CustomView(BasePipelineView):
        """Custom View"""
...
def test_schema__get_parameters__header__partial(drf_request):
    class CustomView(BasePipelineView):
        """Custom View"""
...
def test_schema__get_parameters__header__special_serializer(drf_request):
...
def test_schema__get_parameters__cookie(drf_request):
    class CustomView(BasePipelineView):
        """Custom View"""
...
def test_schema__get_parameters__cookie__partial(drf_request):
    class CustomView(BasePipelineView):
        """Custom View"""
...
def test_schema__get_parameters__cookie__special_serializer(drf_request):
    class CustomSerializer(HeaderAndCookieSerializer):
        """This is the description"""
...
def test_schema__get_request_body(drf_request):
    view = ExampleView()
    view.request = drf_request
    view.request.method = "POST"
    view.format_kwarg = None
...
def test_schema__get_request_body__get(drf_request):
    class CustomView(BasePipelineView):
        """Custom View"""
...
def test_schema__get_request_body__query_parameters(drf_request):
    class CustomView(BasePipelineView):
        """Custom View"""
...
def test_schema__get_tags(drf_request):
    view = ExampleView()
    view.request = drf_request
    view.format_kwarg = None
...
def test_schema__get_tags__predefined(drf_request):
    class CustomView(ExampleView):
        """Custom View"""
    ...
    assert response.data == {
        "components": {
            "schemas": {
                ...
                "DeprecatedOutput": {
                    "properties": {"age": {"type": "integer"}, "email": {"format": "email", "type": "string"}},
                    "required": ["email", "age"],
                    "type": "object",
                },
                ...
                "HeaderAndCookieInput": {
                    "properties": {
                        "Cookie-Name": {"nullable": True, "type": "string"},
                        "Header-Name": {"nullable": True, "type": "string"},
                        "age": {"type": "integer"},
                        "name": {"type": "string"},
                    },
                    "required": ["name", "age"],
                ...
                "HeaderAndCookieOutput": {
                    "properties": {
                        "age": {"type": "integer"},
                        "cookie_name": {"nullable": True, "type": "string"},
                ...
                "User": {
                    "properties": {
                        ...
                        "first_name": {"maxLength": 150, "type": "string"},
                        "id": {"readOnly": True, "type": "integer"},
                        "last_name": {"maxLength": 150, "type": "string"},
                        "username": {
            ...
            "securitySchemes": {
                "another": {"scheme": "basic", "type": "http"},
                "my_security": {"bearerFormat": "JWT", "scheme": "bearer", "type": "http"},
            },
        },
        "info": {
        ...
        "paths": {
                ...
                "post": {
                    ...
                    "requestBody": {
                        "content": {
                            ...
                            "application/x-www-form-urlencoded": {"schema": {"$ref": "#/components/schemas/Input"}},
                            "multipart/form-data": {"schema": {"$ref": "#/components/schemas/Input"}},
                        }
                    },
                    "responses": {
                        "200": {
                        ...
                        "401": {
                            "content": {
                                "application/json": {
                                    "schema": {
                                        "properties": {"detail": {"default": "error " "message", "type": "string"}},
                                        "type": "object",
                                    }
                                }
                            },
            ...
            "/api/example/deprecated/": {
                "post": {
                    ...
                    "requestBody": {
                        "content": {
                            "application/json": {"schema": {"$ref": "#/components/schemas/DeprecatedInput"}},
                            "application/x-www-form-urlencoded": {
                                "schema": {"$ref": "#/components/schemas/DeprecatedInput"}
                            },
                            "multipart/form-data": {"schema": {"$ref": "#/components/schemas/DeprecatedInput"}},
                        }
                    },
                    "responses": {
                        "200": {
                            "content": {
                                "application/json": {"schema": {"$ref": "#/components/schemas/DeprecatedOutput"}}
                            },
                            "description": "Example " "Output",
                        },
                        "401": {
            ...
            "/api/example/headers-and-cookies/": {
                "patch": {
                    ...
                    "responses": {
                        "200": {
                            "content": {
                                "application/json": {"schema": {"$ref": "#/components/schemas/HeaderAndCookieOutput"}}
                            },
                            "description": "Example " "Input",
                        },
                        "401": {
            ...
            "/api/plain/": {
                "get": {
                    "description": "Plain API View",
                    "operationId": "listPlains",
                    "parameters": [],
                    "responses": {
                        "200": {
            ...
            "/api/plain/viewset/{k}/": {
                "get": {
                    "description": "Plain ViewSet",
                    "operationId": "retrievePlainViewSet",
                    "parameters": [
                        {"description": "", "in": "path", "name": "k", "required": True, "schema": {"type": "string"}}
                    ],
                ...
                "get": {
                    ...
                    "responses": {
                        "200": {
                            "content": {
                                "application/json": {
                                    "schema": {"$ref": "#/components/schemas/DeprecatedPydanticoutput"}
                                }
                            },
                            "description": "",
                        },
                ...
                "post": {
                    ...
                    "requestBody": {
                        "content": {
                            ...
                            "multipart/form-data": {"schema": {"$ref": "#/components/schemas/User"}},
                        }
                    },
                    "responses": {
                        "201": {
